...
{
    AudioSource tireScreechingAudioSource;
    ...
    private void Awake()
    {
        topDownCarController = GetComponentInParent<TopDownController>();
    }
    private void Update()
    {
        UpdateEngineSFX();
    ...
    public AudioSource TireScreechingAudioSource { get { return tireScreechingAudioSource; } set { tireScreechingAudioSource = value; } }
    public AudioSource EngineAudioSource { get { return engineAudioSource; } set { engineAudioSource = value; } }
    public AudioSource CarHitAudioSource { get { return carHitAudioSource; } set { carHitAudioSource = value; } }
}
